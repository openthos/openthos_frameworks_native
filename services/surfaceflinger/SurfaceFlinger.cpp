...
status_t SurfaceFlinger::getDisplayConfigs(const sp<IBinder>& display,
    ...
    // TODO: Not sure if display density should handled by SF any longer
     ...
     static int mScreenPhysicalWidth = 0;
     static int mScreenPhysicalHeight = 0;
     static int mScreenDPI = 0;

     static double mScreenPhysicalSize = 0;
     static double mScreenSizeInch = 0;
     static double mCalcuRatio = 25.4;
     static double mIsCanCalcuDPI = false;
#endif
